...
def letterbox(img, height=480, width=640, color=(127.5, 127.5, 127.5)):  # resize a rectangular image to a padded rectangular
...
class JointDataset(LoadImagesAndLabels):  # for training
    def __init__(self, root, paths, img_size=(640,480), augment=False, transforms=None):
        ...
        for ds, path in paths.items():
            ...
            self.label_files[ds] = [x.replace('images', 'labels').replace('.png', '.txt').replace('.jpg', '.txt')
